defmodule PhraseClient do
  @moduledoc """
  Un-official Phrase.com client for elixir, use it to download your
  ...
  defdelegate download_locale(project_id, locale_id, params), to: HTTP
  defdelegate get_project(project_id), to: HTTP
  defdelegate projects, to: HTTP
end
